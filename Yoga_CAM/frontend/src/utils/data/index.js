...
export const tutorials = [
    'Camera Permission: The app requests permission to access the camera. The camera is needed to capture your pose for comparison.',
    'Select Your Pose: Choose the pose you want to perform. The app will show a list of poses for you to select.',
    'Read the Instructions: Before you start, make sure to read the instructions for the selected pose..',
    'Click on Start pose and see the image of the that pose in the right side and replecate that image in front of camera.',
    'Feedback: If you perform the pose correctly, the skeleton overlay on the video will turn green, indicating that you have achieved the correct alignment.'
]

export const fixCamera = [
    'Solution 1: Ensure that you have granted permission for the camera',
    'Solution 2: Ensure that no other application is currently using the camera.',
    "Solution 3: If you're still having trouble, try closing any other open browsers or applications that might be interfering with the camera."
] 
